...
#define NetFunc_3Arg( Loc, Name, Arg1T, Arg2T, Arg3T ) void Name##_ImplNOCALL( const Arg1T & , const Arg2T & , const Arg3T & ); TNetFuncHandle_3< Loc, Arg1T, Arg2T, Arg3T > Name = TNetFuncHandle_3< Loc, Arg1T, Arg2T, Arg3T >( [&]( const Arg1T & a, const Arg2T & b, const Arg3T & c ){ Name##_ImplNOCALL( a, b, c ); } )